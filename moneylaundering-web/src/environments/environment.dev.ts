...
export const environment = {
  ...
  activeDirectory: {
    ...
    redirectUri: 'https://prevencionlavado-dev.sancristobalonline.com.ar/assets/microsoft-graph-auth.html',
    tenatID: 'b6f16b85-9472-48bd-85f5-0dd35eafbb50'
  },
  server: {
    web: {
      home: 'https://prevencionlavado-dev.sancristobalonline.com.ar'
    },
    api: {
      baseUrl: 'https://api-aks-dev.sancristobalonline.com.ar/prevencionlavado-moneylaundering',
