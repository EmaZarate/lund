...
import { CaseHigherInstanceDerivationService } from './../../services/case-higher-instance-derivation.service';
...
@Component({
  selector: 'app-case-higher-instance-derivation',
  templateUrl: './case-higher-instance-derivation.component.html',
  styleUrls: ['./case-higher-instance-derivation.component.scss']
})
export class CaseHigherInstanceDerivationComponent implements OnInit {
  ...
  constructor(
              ...
              private caseDerivation: CaseHigherInstanceDerivationService,
