...
import { AnalystDevolutionService } from './../../services/analyst-devolution.service';
...
@Component({
  selector: 'app-analyst-devolution',
  templateUrl: './analyst-devolution.component.html',
  styleUrls: ['./analyst-devolution.component.scss']
})
export class AnalystDevolutionComponent implements OnInit {

  case: Case;
  person: Person;
  news: Observable<News[]>
  newsReason: number = 14;
  ...
  constructor(
              ...
              private analystDevolutionService: AnalystDevolutionService,
