...
{
    public class CaseDerivationCommandHandler : IRequestHandler<CaseDerivationCommand, bool>
    {
        private readonly INewsRepository newsRepository;
        private readonly IStatusRepository statusRepository;
        private readonly ICaseRepository caseRepository;

        public CaseDerivationCommandHandler(INewsRepository newsRepository,
        ...
        public async Task<bool> Handle(CaseDerivationCommand request, CancellationToken cancellationToken)
        {
            DateTime date = DateTime.Now;
            var caseResult = await this.caseRepository.GetAsync(request.CaseId);
            var statusID = Crosscutting.Identifiers.Status.SuperiorAsignado;
            var newTypeID = Crosscutting.Identifiers.NewsType.AsignaciónSuperior;
